    ...
    <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-slate-700/50 p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        {onOpenSettings && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 text-xs bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-600 dark:text-slate-300 rounded-lg transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all ${
              tradeConfig.enable_trading
                ? 'bg-red-500/20 text-red-600 dark:text-red-400 hover:bg-red-500/30 border border-red-500/50'
                : 'bg-green-500/20 text-green-600 dark:text-green-400 hover:bg-green-500/30 border border-green-500/50'
            }`}
          >
            {tradeConfig.enable_trading ? (
              <>
        ...
        <div className="bg-gray-100 dark:bg-slate-700/30 rounded-lg p-4">
          ...
          <div className="flex items-center justify-center gap-2 px-4 py-2 bg-purple-500/20 text-purple-600 dark:text-purple-400 rounded-lg border border-purple-500/50">
