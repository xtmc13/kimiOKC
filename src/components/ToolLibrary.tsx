    ...
    <div className="h-full overflow-y-auto p-4">
      ...
      {tools.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-slate-400">暂无AI工具</p>
        ...
        <div className="space-y-3">
          {tools.map((tool, index) => (
            <div
              key={index}
              className="p-4 bg-slate-700/30 rounded-lg border border-slate-600/30 hover:border-purple-500/50 transition-colors"
            >
              ...
              {tool.indicators && tool.indicators.length > 0 && (
                <div className="mt-3 pt-3 border-t border-slate-600/30">
                  <div className="text-xs text-slate-500 mb-2">使用指标:</div>
